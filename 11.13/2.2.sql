...
/*2. Вывести количество лекций, которые читает препо-
даватель “Dave McQueen”..*/
...
/*3. Вывести количество занятий, проводимых в ауди-
тории “D201”.*/
...
select 
	min(a.count_students) as min_count_students,
    max(a.count_students) as max_count_students
from
(select
...
group by
	l.`lectureroom`
;
    /*12. Вывести названия факультетов и количество дисци-
плин, которые на них читаются.*/
...
group by
	f.`name`
;
/* 13. Вывести количество лекций для каждой пары препо-
даватель-аудитория.*/
Select
l.`lectureroom`,
t.`name` as teacher_name,
